...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     *
     * Duplicates an asset with a new owner while keeping the original asset with the previous original owner.
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset
     * @param newOwner the new owner
    ...
    public void DuplicateAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        Asset initialAsset = genson.deserialize(assetJSON, Asset.class);
        Asset newAsset = new Asset(initialAsset.getAssetID(), initialAsset.getColor(), initialAsset.getSize(), newOwner, initialAsset.getAppraisedValue());
